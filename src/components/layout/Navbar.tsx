            ...
            <div className="container mx-auto">
                ...
                ">
                    ...
                    <a href="#" className="flex items-center gap-2 ml-4">
                        ...
                        <span className="text-xl font-bold text-white tracking-wider">StayEase</span>
                    </a>
                        ...
                        {navLinks.map((link) => (
                            <a
                                ...
                                className={`
                                    ...
                                    ${link.active ? 'bg-white/20' : 'hover:bg-white/10'}
                                `}
                            >
                                {link.name}
                            </a>
                    ...
                    <div className="hidden lg:flex items-center gap-2 p-1.5 rounded-full border border-white/20 mr-2">
                        <a href="#" className="px-6 py-2 rounded-full text-white text-sm font-medium transition-all duration-300 hover:bg-white/10">
                            Contact us
                        </a>
                        <a href="#" className="px-6 py-2 rounded-full text-white text-sm font-medium bg-white/20 transition-all duration-300">
                            Login
                        </a>
                    </div>
                    ...
                    ">
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <div className="w-full border-t border-white/20 my-2"></div>
                             <a href="#" className="w-full text-center px-6 py-3 rounded-full text-white text-md font-medium transition-all duration-300 hover:bg-white/10">
                                Contact us
                            </a>
                            <a href="#" className="w-full text-center px-6 py-3 rounded-full text-white text-md font-medium bg-white/20 transition-all duration-300">
                                Login
                            </a>
                        </div>
                    </div>
