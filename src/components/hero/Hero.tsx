...
const Hero = () => {
    ...
    return (
        <section className="relative w-full min-h-screen font-sans">
            ...
            {/* Hero Content Wrapper - Padding changes applied here */}
                    ...
                    <div className="booking-card w-full max-w-md mx-auto lg:mx-0 lg:justify-self-end">
                        <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-white/30 to-white/10 backdrop-blur-xs lg:backdrop-blur-lg border border-white/20 shadow-2xl">
                            <div className="flex flex-col gap-4 sm:gap-6">
                                ...
                                {/* Times Section */}
                                <div className="p-3 sm:p-4 rounded-xl bg-white/20 flex items-center gap-4">
                                ...
                                {/* Reserve Button */}
                                <button className="w-full mt-2 py-3 sm:py-4 rounded-2xl bg-white text-gray-900 font-bold text-lg sm:text-xl transition-all hover:bg-gray-200 shadow-lg">
                                    Reserve
                                </button>
                            </div>
                        </div>
